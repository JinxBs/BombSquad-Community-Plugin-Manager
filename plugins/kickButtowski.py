...
class Character(ba.Plugin):
    def on_app_launch(self):
        ...
        # Kick Buttowski #####################################
        t = Appearance('Kick Buttowski')
        t.color_texture = 'kickButtowskiColor'
        t.color_mask_texture = 'kickButtowskiColorMask'
        t.default_color = (0.4, 0.5, 0.4)
        t.default_highlight = (1, 0.5, 0.3)
        t.icon_texture = 'kickButtowskiIconColor'
        t.icon_mask_texture = 'kickButtowskiIconColorMask'
        t.head_model = 'kickButtowskiHead'
        t.torso_model = 'kickButtowskiTorso'
        t.pelvis_model = 'kickButtowskiPelvis'
        t.upper_arm_model = 'kickButtowskiUpperArm'
        t.forearm_model = 'kickButtowskiForeArm'
        t.hand_model = 'kickButtowskiHand'
        t.upper_leg_model = 'kickButtowskiUpperLeg'
        t.lower_leg_model = 'kickButtowskiLowerLeg'
        t.toes_model = 'kickButtowskiToes'
