...
# ba_meta export game
class BetterEliminationGame(ba.TeamGameActivity[Player, Team]):
...
## Add settings ##
            ba.BoolSetting('Live Team Balance (by Nippy#2677)', True),
...
## Add settings ##
        ...
        if issubclass(sessiontype, ba.DualTeamSession):
            ...
            settings.append(
                ba.BoolSetting('Balance Total Life\'s (on spawn only)', default=False))
        return settings
